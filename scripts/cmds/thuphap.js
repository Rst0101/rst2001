this.config = {
 ...
 version: "1.2.9",
 role: 0,
 author: "D-jukie, DuyVuong, ChinhLe",
 info: "Tạo ảnh thư pháp",
 Category: "Tiện ích",
 guides: "[0 -> 3] | [ 1 -> 3 ] | [Text] | [Text 2]",
 cd: 5,
 hasPrefix: true,
 images: [],
};
this.onRun = async ({ event, api, args }) => {
    ...
    let background = (await axios.get(encodeURI(dsCover[content[0]].tpCover), {
    ...
    Canvas.registerFont(__dirname+`/cache/UTM ThuPhap Thien An.ttf`, { family: "UTM ThuPhap Thien An"
    });
   ...
   return api.sendMessage({ attachment: fs.createReadStream(pathImg) }, threadID,messageID);
}